...
```
// 安裝執行檔和 .dat 資料檔
# bash <(curl -L https://raw.githubusercontent.com/bv5757/fhs-install-v2ray/master/install-release.sh)
```
...
```
// 只更新 .dat 資料檔
# bash <(curl -L https://raw.githubusercontent.com/bv5757/fhs-install-v2ray/master/install-dat-release.sh)
```

### 移除 V2Ray

```
# bash <(curl -L https://raw.githubusercontent.com/bv5757/fhs-install-v2ray/master/install-release.sh) --remove
```
